...
const PROCESS_TYPE = Object.freeze({
  ...
  STUDENT_SELECT_INTERNSHIP: 'STUDENT_SELECT_INTERNSHIP', // 学生实习项目安排
  TEACHER_SELECT_INTERNALSHIP: 'TEACHER_SELECT_INTERNALSHIP', // 校内指导老师实习项目安排
  TUTOR_SELECT_INTERNALSHIP: 'TUTOR_SELECT_INTERNALSHIP', // 企业老师实习项目安排
  INTERNAL_TEACHER_SELECT_PROJECT: 'INTERNAL_TEACHER_SELECT_PROJECT', // 校内实习-分配指导老师
  INTERNAL_TEACHER_DECLARE_TOPIC: 'INTERNAL_TEACHER_DECLARE_TOPIC', // 校内实习-老师申报题目
  ...
  EXTERNAL_STUDENT_SELECT_POST: 'EXTERNAL_STUDENT_SELECT_POST', // 校外实习-学生报名岗位
