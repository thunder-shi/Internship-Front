<template>
  <div v-loading="loading" class="cascader-wrapper">
    <el-cascader v-if="isShowInfo" ref="cascader" v-model="arrVal" class="cascader" :multiple="multiple" :append-to-body="false" :size="size" :options="options" :props="cascaderProps" :placeholder="placeholder" clearable="" @change="handleChange" />
  </div>
</template>
<script setup>
// cascader没有loading属性
...
function handleChange(val) {
  ...
  emit('update-value', lastId, props.field)
}
...
watch(() => actualValue.value, async (val) => {
