  ...
  defaultDTLProps: {
    ...
    defaultDTHProps: {
      ...
      allTableColumns: [
        ...
        { id: 5, showName: '联系邮箱', theOrder: 5, tableColumnName: 'contactEmail', sortable: true },
        { id: 6, showName: '当前有效', theOrder: 6, tableColumnName: 'customize-current'},
        { id: 7, showName: '当前状态', theOrder: 7, tableColumnName: 'isAudit', sortable: true},
        //{ id: 8, showName: '审核意见', theOrder: 8, tableColumnName: 'reason' },
        { id: 9, showName: '更新时间', theOrder: 9, tableColumnName: 'updateTime', sortable: true },
      ],
    },
  },
}));
