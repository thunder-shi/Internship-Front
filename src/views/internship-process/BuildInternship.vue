  ...
  defaultDTLProps: {
    defaultDTHProps: {
      ...
      allTableColumns: [
        ...
        { id: 7, showName: '上报开始时间', theOrder: 7, tableColumnName: 'reportStartTime', sortable: true },
        { id: 8, showName: '上报结束时间', theOrder: 8, tableColumnName: 'reportEndTime', sortable: true },
