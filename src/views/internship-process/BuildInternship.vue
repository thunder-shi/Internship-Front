  ...
  defaultDTLProps: {
    defaultDTHProps: {
      ...
      allTableColumns: [
        ...
        { id: 6, showName: '上报开始日期', theOrder: 6, tableColumnName: 'reportStartDate', sortable: true },
        { id: 7, showName: '上报结束日期', theOrder: 7, tableColumnName: 'reportEndDate', sortable: true },
